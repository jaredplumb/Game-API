...
uint32 PSystem::GetRandom (uint32 range) {
	if(_RANDOM_SEED == 0)
...
uint32 PSystem::SetRandomSeed (uint32 seed) {
	uint32 original = _RANDOM_SEED;
	_RANDOM_SEED = seed;
	return original;
}

uint64 PSystem::GetHash (const uint8* bytes) {
...
int_t PSystem::NewStartupCallback (void (* callback) ()) {
...
int_t PSystem::NewShutdownCallback (void (* callback) ()) {
...
int_t PSystem::NewDrawCallback (void (* callback) ()) {
...
int_t PSystem::NewMouseCallback (void (* callback) (int_t x, int_t y, int_t button)) {
...
int_t PSystem::NewMouseUpCallback (void (* callback) (int_t x, int_t y, int_t button)) {
...
int_t PSystem::NewMouseMoveCallback (void (* callback) (int_t x, int_t y)) {
...
int_t PSystem::NewMouseDragCallback (void (* callback) (int_t x, int_t y, int_t button)) {
...
int_t PSystem::NewMouseWheelCallback (void (* callback) (float xdelta, float ydelta)) {
...
int_t PSystem::NewKeyCallback (void (* callback) (vkey_t key)) {
...
int_t PSystem::NewKeyUpCallback (void (* callback) (vkey_t key)) {
...
int_t PSystem::NewASCIICallback (void (* callback) (char key)) {
...
int_t PSystem::NewTouchCallback (void (* callback) (int_t x, int_t y)) {
...
int_t PSystem::NewTouchUpCallback (void (* callback) (int_t x, int_t y)) {
...
int_t PSystem::NewTouchMoveCallback (void (* callback) (int_t x, int_t y)) {
